...
-- NB: window function always performs calculation on the result set after JOIN/WHERE/GROUPBY/HAVING and before ORDER BY, over() is not specified entire result set is treated as 1 partition